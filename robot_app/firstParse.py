...
def reformatData(inData):
    ...
    for i in range(numWugs):
        ...
        memoryResponse.append(trial['names'][trial['response']])
        memoryRts.append(trial['rt'])
        memoryCorrect.append((trial['names'][trial['response']]) == correctName)
    ...
    tData['numMemoryCorrect2'] = sum([r for r in memoryCorrect if r])
